...
namespace SpatialPartitionPattern
{
    public class GameController : MonoBehaviour
    {
        ...
        //A Rotation Quaternion to hopefully show the dogs and cats right side up
        ...
        void Start()
        {
            ...
            for (int i = 0; i < numberOfSoldiers; i++)
            {
                ...
                Vector3 randomPos = new Vector3(Random.Range(0f, mapWidth), .5f, Random.Range(0f, mapWidth));

                //Create a new enemy
                GameObject newEnemy = Instantiate(enemyObj, randomPos,rotation) as GameObject;
                ...
                randomPos = new Vector3(Random.Range(0f, mapWidth), 1.5f, Random.Range(0f, mapWidth));
